...
// функцию передается строка, содержащая английскиие буквы, функция фолжна вернуть массив, содержащий все возможные комбинации букв. Повторяющихся строк в массиве быть не должно.
...
// В функцию передается 2 строки, из функции нужно вернуть строку в которой сначала будет записана короткая строка, потом длинная, потом снова короткая.
...
//   }
// }
// console.log(func('1', '22'))
// console.log(func('22', '1'))

//==================================================================================================


// В функцию передается массив с целыми цислами. Необходимо реализовать функцию так, чтобы она возвращала сумму квадратных короней всех четных элементов массива
...
// В функцию передается массив объектов. необъодимо вернуть из функции отсортированный массив в возрастающем порядке по значению свойства val объекта, при этом в возвращаемом массиве не должно быть объекто у которых val отрицательный.

// function sortArr(arr) {
//  return arr.filter(elem => elem.val > 0).sort((a, b) => a.val - b.val)
// }
...
// console.log(sortArr(arrT))

//====================================================================================================================

//В функцию передается число напишите функцию по вычислению данного числа фибоначи
